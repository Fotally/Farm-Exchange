...
- `scripts/FarmGame.cs`：游戏状态模块。持有固定 128×128 土地、每块农田所选作物、配套加工场地、工人轮流工作、tick 与天数、分类库存、交易和购地规则；界面通过格子快照、作物定义与经营命令使用它。
...
- `docs/生产与交易.md`：六种作物的数值、加工对应关系、选种、出售、购地规则与代码对应。
