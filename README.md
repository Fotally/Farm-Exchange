...
Farm Exchange 是使用 Godot 4.7.2 Mono 与 C# 制作的等距视角放置挂机游戏。玩家在 128×128 的地图上建农田，工人按 tick 自动照料作物；原料交给对应场地加工，加工品出售后可解锁更多土地。当前有六种作物及对应加工场地。存档与离线收益尚待确认。
...
项目尚未确定开源许可证。后续引入第三方素材时，按[素材命名与来源规范](.codex/rules/assets.md)记录授权和适用文件。
